...
const UpdateGroupChatModal = ({ fetchMessages, fetchAgain, setFetchAgain }) => {
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            toast({
                title: 'Error Occured!',
                description: "Couldn't rename the group",
                status: 'error',
                duration: 3000,
                isClosable: true,
                position: 'top'
    ...
    const handleRemove = async (user1) => {
        ...
        try {
            ...
            user1._id === user._id ? updateSelectedChat('') : updateSelectedChat(data);
            setFetchAgain(!fetchAgain);
            fetchMessages();
            setLoading(false);
        } catch (error) {
            toast({
                title: 'Error Occured!',
                description: "Couldn't remove the user",
                status: 'error',
                duration: 3000,
                isClosable: true,
                position: 'top'
